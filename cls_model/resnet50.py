...
BATCH_SIZE = 16
LEARNING_RATE = 1e-4
NUM_EPOCHS = 100 # Early Stopping이 있으므로 에폭을 넉넉하게(50~100) 잡아도 됩니다.
PATIENCE = 5     # 5번 연속으로 Loss가 안 줄어들면 종료
IMG_SIZE = 256
...
class EarlyStopping:
    def __init__(self, patience=5, verbose=False, delta=0):
        ...
        Args:
            ...
            verbose (bool): True일 경우 로그 출력
            delta (float): 개선되었다고 판단할 최소 변화량
        """
...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs, patience=5):
    ...
    for epoch in range(num_epochs):
        ...
        if early_stopping.early_stop:
            print("🛑 Early Stopping triggered! 학습을 조기 종료합니다.")
            break
